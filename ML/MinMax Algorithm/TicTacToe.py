"""
This project is a simple implementation of the MinMax algorithm for the TicTacToe game.

"""
from minmaxagent import MinMaxAgent
from tables import TicTacToe
...
def main():
    ...
    if player_letter not in game.available_letters:
        ...
        return
    difficulty = int(input('Choose difficulty level 0-9: '))
    if player_letter == 'X':
