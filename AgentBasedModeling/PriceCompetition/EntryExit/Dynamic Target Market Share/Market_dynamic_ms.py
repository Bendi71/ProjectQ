...
class Market:
    ...
    def set_parameters(self, num_consumers: int, num_sellers: int, noise_variance: float, target_parameter: float,
        ...
        logging.info(
            f"Parameters set: {num_consumers=}, {num_sellers=}, {noise_variance=}, {target_parameter=}, {epsilon=}, {initial_price=}, {entry_probability=}, {exit_threshold=}")
    ...
    def step(self) -> None:
        for seller in self.sellers:
            ...
            seller.price_adjustment(1 / len(self.sellers) + self.target_parameter, self.epsilon)
    ...
    def save_data(self, step) -> dict:
        ...
        return {
            ...
            "target_market_share": 1 / len(self.sellers) + self.target_parameter,
